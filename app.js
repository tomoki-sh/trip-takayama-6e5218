...
const DATA = {
  ...
  spots: [
    ...
    },
    {
      ...
      meta: [
        ["営業", "8:00〜17:00（Google表示。公式の夏季時間は直前確認）"],
        ["電話", "0577-79-2211"],
    ...
    },
    {
      ...
      badges: [
        { text: "犬同伴の明記なし", cls: "priority-warn" },
        { text: "8/12は水曜休館", cls: "priority-warn" }
      ],
      ratings: { google: "4.3", googleReviews: "1173" },
      desc: "ピラミッド型の外観で知られる大型museum。事前調査からの候補だが、犬の扱いが解決しない限り主計画には入らない。",
      meta: [
        ["営業", "10:00〜17:00（最終入館16:00）・**水曜休館**"],
        ["電話", "0577-34-6511"],
        ["犬", "**同伴可の公式明記を確認できず**。犬の安全な待機方法がない限り利用しない"],
        ["滞在", "2時間以上（見応えがあるぶん長い）"],
        ["扱い", "**主計画から除外**。犬の待機が正式に確保できた場合のみ検討"]
      ],
      maps: "光ミュージアム 高山"
    },
    {
  ...
  plans: [
    {
      title: "8/8（土）｜八尾 → 高山・ホテルステイ開始",
      featured: true,
      route: "移動だけの日。観光は入れない",
      items: [
        ["10:00", "八尾を出発（お盆の下り混雑を避けて前倒し）", "確定"],
        ["11:30", "多賀SA（上り）ドッグランで給水・排泄", "未確定"],
        ["13:30", "長良川SA（下り）ドッグランで休憩", "未確定"],
        ["16:00", "サンクチュアリコート高山 到着・チェックイン", "確定"],
        ["16:30", "犬の館内動線・ケージ・ドッグランを現地で確認", "確定"],
    ...
    },
    {
      title: "8/9（日）｜飛騨の里 ＋ 大喜",
      featured: true,
      route: "午前に主目的1つ、午後はホテル",
      items: [
        ["08:15", "ホテル出発（涼しいうちに）", "確定"],
        ["08:30", "飛騨の里（開園直後・1.5〜2時間）", "確定"],
        ["10:30", "お食事処 大喜で昼食（要予約・犬と店内）", "未確定"],
        ["12:30", "ホテルへ戻る（午後は休憩・ドッグラン）", "確定"],
        ["17:00", "スカイパークで短い散歩（涼しければ・任意）", "未確定"],
        ["18:30", "ホテルの日本料理（固定）", "確定"],
        ["19:30", "手筒花火（宮川周辺）。犬は連れて行かず音対策", "確定"]
      ]
    },
    {
      title: "8/10（月）｜朝市・匠館・JA・ぼくんち",
      featured: true,
      route: "朝の涼しい時間に町へ、昼で切り上げ",
      items: [
        ["07:15", "ホテル出発", "確定"],
        ["07:30", "宮川朝市・古い町並（1時間強）", "確定"],
        ["09:00", "匠館（全フロア犬同伴可・雨でも可）", "未確定"],
        ["10:10", "JA産直市場アグリ高山（同行者の希望・交代で入店）", "確定"],
        ["11:00", "coffee & kitchen ぼくんちで昼食（犬と店内）", "未確定"],
        ["12:45", "ホテルへ戻る", "確定"],
        ["18:30", "ホテルのイタリアン（固定）", "確定"]
      ]
    },
    {
      ...
      items: [
        ["08:00", "ホテル出発（市街地のイベント混雑を回避）", "確定"],
        ["08:30", "飛騨大鍾乳洞（約12℃・上着とすべりにくい靴）", "確定"],
        ["10:45", "自然薯 茶茶 じねんのむら（開店直後・予約不可）", "未確定"],
        ["13:00", "ホテルへ戻る（午後は休憩）", "確定"],
        ["18:30", "ホテルの鉄板焼き（固定・同席者が1名増える予定）", "確定"],
        ["19:30", "久々野の花火（〜22:30）。犬の音対策を優先", "確定"]
      ]
    },
    {
      title: "8/12（水）｜山田春慶店 → 彦根 → 八尾",
      featured: true,
      route: "移動日。山田春慶店は営業確認しだい",
      items: [
        ["07:30", "朝食・荷造り・犬の散歩", "確定"],
        ["09:30", "チェックアウト（犬はキャリーで移動）", "確定"],
        ["10:00", "山田春慶店（8/11夕方までに営業再開を電話確認）", "未確定"],
        ["11:00", "高山を出発", "確定"],
        ["13:00", "関SA（上り）ドッグランで休憩", "確定"],
        ["15:00", "尾張一宮PA（下り）で2回目の休憩（必要時）", "未確定"],
        ["16:30", "彦根 到着", "確定"],
        ["18:30", "同行者と犬2匹は八尾へ", "確定"]
      ]
    },
    {
      title: "雨・猛暑のときの差し替え版",
...
const TRIP_DAYS = [
  ...
  { key: "2026-08-10", label: "8/10（月）", sub: "朝市・匠館・JA・ぼくんち" },
...
const SCHED_DEFAULT = [
  /* ---- 8/8（土）八尾 → 高山 ---- */
  { day: "2026-08-08", time: "10:00", text: "八尾を出発（お盆の下り混雑。可能なら前倒し）", status: "confirmed", ref: "spot:近鉄八尾駅（出発・帰着の目安）" },
  { day: "2026-08-08", time: "11:30", end: "12:00", text: "多賀SA（上り）ドッグランで給水・排泄", status: "tentative", ref: "spot:多賀SA（上り・ドッグラン）" },
  { day: "2026-08-08", time: "13:30", end: "14:00", text: "長良川SA（下り）ドッグランで休憩", status: "tentative", ref: "spot:長良川SA（下り・ドッグラン）" },
  { day: "2026-08-08", time: "16:00", text: "サンクチュアリコート高山 到着・チェックイン", status: "confirmed", ref: "spot:サンクチュアリコート高山（拠点）" },
  { day: "2026-08-08", time: "16:30", end: "17:30", text: "犬の館内動線・客室ケージ・ドッグランを現地で確認", status: "confirmed" },
  { day: "2026-08-08", time: "18:30", text: "ホテルのイタリアン【固定】", status: "confirmed" },

  /* ---- 8/9（日）飛騨の里 ---- */
  { day: "2026-08-09", time: "08:15", text: "ホテル出発（涼しいうちに）", status: "confirmed" },
  { day: "2026-08-09", time: "08:30", end: "10:15", text: "飛騨の里（開園直後・全域は回り切らない）", status: "confirmed", ref: "spot:飛騨の里" },
  { day: "2026-08-09", time: "10:30", end: "12:00", text: "お食事処 大喜で昼食（要予約・犬と店内）", status: "tentative", ref: "restaurant:お食事処 大喜" },
  { day: "2026-08-09", time: "12:30", text: "ホテルへ戻る（午後は休憩・ドッグラン）", status: "confirmed" },
  { day: "2026-08-09", time: "17:00", end: "17:40", text: "スカイパークで短い散歩（涼しければ・任意）", status: "tentative", ref: "spot:アルプス展望公園 スカイパーク" },
  { day: "2026-08-09", time: "18:30", text: "ホテルの日本料理【固定】", status: "confirmed" },
  { day: "2026-08-09", time: "19:30", text: "手筒花火（宮川周辺）。犬は連れて行かず音対策", status: "confirmed" },

  /* ---- 8/10（月）朝市 ---- */
  { day: "2026-08-10", time: "07:15", text: "ホテル出発（朝市の混雑と暑さを避ける）", status: "confirmed" },
  { day: "2026-08-10", time: "07:30", end: "08:45", text: "宮川朝市・古い町並（散策は1時間前後で切る）", status: "confirmed", ref: "spot:宮川朝市" },
  { day: "2026-08-10", time: "09:00", end: "09:50", text: "匠館（全フロア犬同伴可・雨でも可）", status: "tentative", ref: "spot:匠館" },
  { day: "2026-08-10", time: "10:10", end: "10:40", text: "JA産直市場アグリ高山【同行者の希望・交代で入店】", status: "confirmed", ref: "spot:JA産直市場 アグリ高山" },
  { day: "2026-08-10", time: "11:00", end: "12:15", text: "ぼくんちで昼食（犬と店内・駐車場なし）", status: "tentative", ref: "restaurant:coffee & kitchen ぼくんち" },
  { day: "2026-08-10", time: "12:45", text: "ホテルへ戻る（午後はホテルステイ）", status: "confirmed" },
  { day: "2026-08-10", time: "18:30", text: "ホテルのイタリアン【固定】", status: "confirmed" },

  /* ---- 8/11（火・祝）鍾乳洞 ---- */
  { day: "2026-08-11", time: "08:00", text: "ホテル出発（市街地の山の日イベント混雑を回避）", status: "confirmed" },
  { day: "2026-08-11", time: "08:30", end: "10:15", text: "飛騨大鍾乳洞（約12℃・上着とすべりにくい靴）", status: "confirmed", ref: "spot:飛騨大鍾乳洞" },
  { day: "2026-08-11", time: "10:45", end: "12:15", text: "自然薯 茶茶 じねんのむら（予約不可・開店直後）", status: "tentative", ref: "restaurant:自然薯 茶茶 じねんのむら 飛騨高山店" },
  { day: "2026-08-11", time: "13:00", text: "ホテルへ戻る（市街地のイベントは追加しない）", status: "confirmed" },
  { day: "2026-08-11", time: "17:00", text: "山田春慶店へ電話し、8/12の営業再開を確認", status: "confirmed" },
  ...
  /* ---- 8/12（水）高山 → 彦根 → 八尾 ---- */
  { day: "2026-08-12", time: "07:30", text: "朝食・荷造り・犬の散歩（急がない）", status: "confirmed" },
  { day: "2026-08-12", time: "09:30", text: "チェックアウト準備（犬はキャリーで移動）", status: "confirmed" },
  { day: "2026-08-12", time: "10:00", end: "10:40", text: "山田春慶店【同行者の希望・前日に営業確認】", status: "tentative", ref: "spot:山田春慶店" },
  { day: "2026-08-12", time: "11:00", text: "高山を出発（昼食は軽食またはSAで）", status: "confirmed" },
  { day: "2026-08-12", time: "13:00", end: "13:30", text: "関SA（上り）ドッグランで休憩", status: "confirmed", ref: "spot:関SA（上り・ドッグラン）" },
  { day: "2026-08-12", time: "15:00", end: "15:20", text: "尾張一宮PA（下り）で2回目の休憩（必要時）", status: "tentative", ref: "spot:尾張一宮PA（下り・ドッグラン）" },
  { day: "2026-08-12", time: "16:30", text: "彦根 到着", status: "confirmed", ref: "spot:彦根城（8/12の目的地の目安）" },
  { day: "2026-08-12", time: "18:30", text: "同行者と犬2匹は八尾へ", status: "confirmed", ref: "spot:近鉄八尾駅（出発・帰着の目安）" }
];
...
async function loadWeather() {
  ...
  try {
    ...
    // その日の主目的に合わせた分岐文言（DATA.branches と整合させること）
    const adviceFor = (iso, rain, hot) => {
      const plan = {
        "2026-08-08": ["移動日。到着後の観光は入れず、ホテルへ安全に着くことを最優先に。", "SAのドッグランは<b>路面が熱ければ短時間</b>に。給水をこまめに。", "雷雨なら<b>SAでの外出を最小限</b>にし、車内で休ませてから走る。"],
        "2026-08-09": ["<b>飛騨の里は開園直後（8:30）</b>に入り、1.5〜2時間で切り上げる。", "屋外中心なので<b>11時以降は歩かせない</b>。大喜の店内席で涼む。", "飛騨の里を短縮または中止し、<b>大喜の昼食だけ</b>に絞る。"],
        "2026-08-10": ["朝市は<b>7:30到着</b>。混む前に1時間で切り上げる。", "朝市を短縮し、<b>匠館とぼくんちの屋内</b>を長めに取る。", "朝市は中止して<b>匠館→ぼくんち</b>へ。JAは大人が交代で。"],
        "2026-08-11": ["<b>鍾乳洞は約12℃</b>。薄手の上着を忘れずに。市街地のイベント混雑は避ける。", "鍾乳洞は暑さに強い。<b>茶茶はテラスを避けて蔵太</b>を狙う。", "鍾乳洞は実施可だが<b>足元が滑る</b>。茶茶は蔵太のみ。雷なら中止しホテルへ。"],
        "2026-08-12": ["山田春慶店（前日に営業確認）→出発。SAで犬をしっかり休ませる。", "出発を早め、<b>SAの滞在は日陰で短く</b>。", "山田春慶店だけ寄って移動。<b>路面状況を確認</b>してから高速へ。"]
      }[iso];
      if (!plan) return "";
      return rain ? plan[2] : (hot ? plan[1] : plan[0]);
    };
